        ...
        <div className="flex md:px-8 px-6 w-full md:py-0 py-2 md:h-full h-[79vh] my-auto">
          ...
          >
            {projects.map((p) => (
              <li
                key={p.id}
                className="text-black rounded-b-[1rem] rounded-t-[30rem] md:p-6 p-4 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-300 bg-[#9BBEC8]"
              >
